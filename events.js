...
const localEmpireEvents = [
	...
	'<span class="local-event-destiny-optional">IMPERIAL CORRUPTION:</span> A uniformed officer has some Corellian Whiskey that "fell off the delivery skiff".',
	'<span class="local-event-destiny-optional">IMPERIAL CORRUPTION:</span> A uniformed officer has some Whyren\'s Reserve that "fell off the delivery skiff".',
...
const localOldWestEvents = [
	...
	'<span class="local-event-free">WRETCHED HIVE:</span> <i>"Wanna buy some Death Sticks?"</i>',
	...
	'<span class="local-event-destiny-optional">YOUR DEALER CALLED:</span> <i>"Psst! I got some sweet <a href="https://star-wars-rpg-ffg.fandom.com/wiki/Death_Sticks" target="_blank">Death Sticks</a>."</i> (' + htmlUpgradeAbility1x + ' Charm/Cool/Resilience once; +' + htmlSetbackDie + ' all tasks, one encounter)',
	'<span class="local-event-destiny-optional">YOUR DEALER CALLED:</span> <i>"Psst! I got some kickin\' <a href="https://star-wars-rpg-ffg.fandom.com/wiki/Glitterstim" target="_blank">Glitterstim</a>."</i> (+' + htmlBoostDie + '' + htmlBoostDie + '' + htmlBoostDie + ' all Perception & Vigilance, one encounter; highly addictive; possible temporary telepathy)',
	...
	'<span class="local-event-destiny-optional">YOUR DEALER CALLED:</span> <i>"Psst! I got some pure <a href="https://star-wars-rpg-ffg.fandom.com/wiki/Ji_Rikknit" target="_blank">Ji Rikknit</a> right here."</i> (recover 1 Strain; Easy ' + htmlDifficultyDie + ' per dose Resilience to avoid 1 Obligation [addiction])',
	...
	'<span class="local-event-destiny-optional">YOUR DEALER CALLED:</span> <i>"Psst! I got some <a href="https://star-wars-rpg-ffg.fandom.com/wiki/Bubse_Spice" target="_blank">Bubse</a>."</i> (Wound Threshold +4, one encounter; +20 Critical Hit result, one encounter)',
