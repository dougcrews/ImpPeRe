...
const localEmpireEvents = [
	...
	'<span class="local-event-destiny-optional">I KNOW A GUY:</span> +' + htmlBoostDie + ' to Lore check(s).',
	'<span class="local-event-destiny-optional">I KNOW A GUY:</span> +' + htmlBoostDie + ' to Medicine check(s).',
	...
	'<span class="local-event-destiny-optional">I KNOW A GUY:</span> +' + htmlBoostDie + ' to Xenology check(s).',
	...
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Athletics check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Charm check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Coercion check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Computers check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Cool check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Coordination check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Core Worlds check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Deception check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Discipline check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Driving check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Education check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Leadership check.',
	...
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Negotiation check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Outer Rim check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Perception check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Piloting check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Resilience check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Skulduggery check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Stealth check.',
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Streetwise check.',
	...
	'<span class="local-event-free">IT FLOWS THROUGH ALL:</span> Gain +' + htmlForceDie + ' on next Vigilance check.',
